...
function preload(){
  ...
  // bellSound = loadSound("bell.mp3"),,Maam this is not working.
}
...
if(gameState===END && keyWentDown("r")){
 reset();
  ...
  text("use 'up' and 'down' arrow keys to control the cyclist.",10,280)
}
